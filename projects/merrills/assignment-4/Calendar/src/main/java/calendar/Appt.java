...
public class Appt implements  Comparable<Appt>{
	...
	//ERROR Causes out of bounds error for January
    	if(startHour<0 || startHour>23)
        	...
        	if(startMinute<0 || startMinute>59)
            	...
            	if((startDay<1 || startDay>NumDaysInMonth) /*|| (startDay>15 && 
							     startDay<20)*/) 
			//Middle of month bug
            		this.valid=false;
            	else
                	if(startMonth<1 || startMonth>12)//ERROR months only go
                		this.valid=false;	 //from 2 to 11
                	else
                		this.valid=true;
    }
